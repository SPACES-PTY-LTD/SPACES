        ...
        return [
            ...
            'shipment' => $this->shipment ? [
                ...
                'pickup_location' => $this->shipment->pickupLocation ? [
                    ...
                    'company' => $this->shipment->pickupLocation->company,
                    'code' => $this->shipment->pickupLocation->code,
                    'full_address' => $this->shipment->pickupLocation->full_address,
                ] : null,
                'dropoff_location' => $this->shipment->dropoffLocation ? [
                    'location_id' => $this->shipment->dropoffLocation->uuid,
                    'name' => $this->shipment->dropoffLocation->name,
                    'company' => $this->shipment->dropoffLocation->company,
                    'code' => $this->shipment->dropoffLocation->code,
                    'full_address' => $this->shipment->dropoffLocation->full_address,
                ] : null,
            ] : null,
