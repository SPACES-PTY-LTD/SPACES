    ...
    <div className="space-y-6 max-w-full ">
      ...
      <ExportableDataTable
        ...
        columns={[
          ...
          { key: "from_time_in", label: "Pickup Time In", type: "date_time", format: "YYYY-MM-DD HH:mm", link: "shipment_href" },
          { key: "from_time_out", label: "Pickup Time Out", type: "date_time", format: "YYYY-MM-DD HH:mm", link: "shipment_href" },
          {
            key: "from_total_time",
          ...
          { key: "to_time_in", label: "Drop-off Time In", type: "date_time", format: "YYYY-MM-DD HH:mm", link: "shipment_href" },
          { key: "to_time_out", label: "Drop-off Time Out", type: "date_time", format: "YYYY-MM-DD HH:mm", link: "shipment_href" },
          {
            key: "to_total_time",
            label: "Drop-off Total Time",
            type: "dwell_time",
            link: "shipment_href",
            className: "w-[170px]",
            dwellTime: {
